...
const showRecipe = async function() {
    try {
        ...
        if (!id) return;
        _recipeViewDefault.default.loadingSpinner();
        await _modelJs.loadRecipe(id);
        const data = _modelJs.state.recipe;
        console.log(data);
        _recipeViewDefault.default.render(data);
    // 2) Rendering recipe
    } catch (err) {
...
const searchController = async function() {
    try {
        ...
        const data = _modelJs.paginationLogic(3);
...
_recipeViewDefault.default.addHandlerEvent(showRecipe);
//////////////////////
...
},{"./model.js":"Y4A21","./views/recipeView":"l60JC","./views/searchView.js":"9OQAM","regenerator-runtime":"dXNgZ","./views/resultsView.js":"cSbZE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/paginationView.js":"6z7bi"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg"); // parcel1
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class RecipeView {
    #errorMessage = 'Siz qidirgan malumot topilmadi!!!';
   ...
   `;
    ...
    addHandlerEvent(data) {
        [
            ...
            return window.addEventListener(val, data);
        });
    }
    renderError() {
...
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class ResultsView {
    #parantElement = document.querySelector('.results');
    #data;
    render(data) {
        this.#data = data;
        this.#data.map((val)=>{
    ...
    `;
        this.#parantElement.insertAdjacentHTML('afterbegin', html);
    }
}
...
class PaginationView {
    ...
    addHandlerEvent(handle) {
        this.#parentElement.addEventListener('click', function(e) {
            if (e.target.closest('.btn-inline')) handle();
        });
    }
     #generateHTML() {
    ...
    `;
        if (currentPage > 1) this.#parentElement.insertAdjacentHTML('afterbegin', btnPre);
        if (endPage < currentPage) this.#parentElement.insertAdjacentHTML('afterbegin', btnNext);
    }
}
